...
int bcm2835_i2c_begin(unsigned char i2c_pin)
{
    uint16_t cdiv;
    uint8_t I2C_SDA=0,I2C_SCL=1;
...
//#ifdef I2C_V1
    ...
    bcm2835_gpio_fsel(I2C_SDA, BCM2835_GPIO_FSEL_ALT0); /* SDA */
    bcm2835_gpio_fsel(I2C_SCL, BCM2835_GPIO_FSEL_ALT0); /* SCL */
//#else
//    volatile uint32_t* paddr = bcm2835_bsc1 + BCM2835_BSC_DIV/4;
    /* Set the I2C/BSC1 pins to the Alt 0 function to enable I2C access on them */
//    bcm2835_gpio_fsel(RPI_CM3_GPIO28, BCM2835_GPIO_FSEL_ALT0); /* SDA */
//    bcm2835_gpio_fsel(RPI_CM3_GPIO29, BCM2835_GPIO_FSEL_ALT0); /* SCL */
//#endif    
...
void bcm2835_i2c_end(uint8_t i2c_pin)
{
    uint8_t I2C_SDA=0,I2C_SCL=1;
    if(i2c_pin==0)
    {
...
//#ifdef I2C_V1
    ...
    bcm2835_gpio_fsel(I2C_SDA, BCM2835_GPIO_FSEL_INPT); /* SDA */
    bcm2835_gpio_fsel(I2C_SCL, BCM2835_GPIO_FSEL_INPT); /* SCL */
//#else
    /* Set all the I2C/BSC1 pins back to input */
//    bcm2835_gpio_fsel(RPI_CM3_GPIO28, BCM2835_GPIO_FSEL_INPT); /* SDA */
//    bcm2835_gpio_fsel(RPI_CM3_GPIO29, BCM2835_GPIO_FSEL_INPT); /* SCL */
//#endif
}
